...
import { handleSectionScroll } from "./smoothScrollTo";
...
// Real Sorta Famous brand statements (from sortafamous.in), rotated as the big
// reveal line. Not testimonials — these are the agency's own positioning lines.
const QUOTES = [
    ...
    "Insight-led PR that turns strategy into status with substance.",
];
...
// Source: index-2 (dark) / Section5 — scattered avatar thumbnails that spread
// on scroll (GSAP ScrollTrigger) + rotating testimonial reveal text + "Get in touch".
export default function HeroScatterTestimonial() {
